...
<head>
    ...
    <!--Stylesheets-->
    <link rel='stylesheet' href='css/gsweb.css'>
    <link rel='stylesheet' href='css/scroll.css'>
    <link rel='stylesheet' href='css/style.css'>

    <!--Title-->
    <title>Catalog &#124; DTI Trader</title>
</head>
<!--End head-->
                ...
                <div class="col-12 col-md-5 col-lg-3 bl-1">
                    <form>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="inf_firstname" placeholder="First Name">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="inf_lastname" placeholder="Last Name">
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-control" name="inf_email" placeholder="Email">
                        </div>
                        <div class="form-group">
                            <input type="tel" class="form-control" name="inf_phone" placeholder="Mobile # For SMS">
                        </div>
                        ...
                        <div class="form-group">
                            <select class="form-control" name="inf_country">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="inf_street" placeholder="Street address">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="inf_zip" placeholder="ZIP">
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="inf_card" placeholder="Credit Card Number">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <select class="form-control" name="inf_month">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <select class="form-control" name="inf_year">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="inf_cvc" placeholder="CVC">
                                </div>
                            </div>
                        </div>
